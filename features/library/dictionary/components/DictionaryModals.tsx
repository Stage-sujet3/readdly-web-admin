                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="space-y-1.5">
                        ...
                        <select className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 outline-none focus:border-amber-500 text-slate-700 font-bold text-sm cursor-pointer appearance-none" value={theme} onChange={(e) => setTheme(e.target.value)}>
                      ...
                      words.map((word, index) => (
                        <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} key={index} className="group flex gap-4 items-center bg-white border border-slate-100 p-4 rounded-[1.5rem] hover:shadow-lg hover:shadow-slate-200/50 transition-all">
                          ...
                          <div className="flex-1 grid grid-cols-5 gap-3">
                            ...
                            <select className="bg-slate-50/50 border border-slate-100 rounded-xl px-4 py-2.5 outline-none focus:bg-white focus:border-indigo-500 text-sm font-bold appearance-none cursor-pointer" value={word.theme} onChange={(e) => handleUpdateWord(index, 'theme', e.target.value)}>
                              <option value="Général">Général</option>
                              <option value="Animaux">Animaux</option>
                              <option value="École">École</option>
                              <option value="Émotions">Émotions</option>
                            ...
                            <input type="text" placeholder="Exemple" className="bg-slate-50/50 border border-slate-100 rounded-xl px-4 py-2.5 outline-none focus:bg-white focus:border-indigo-500 text-sm italic" value={word.example || ''} onChange={(e) => handleUpdateWord(index, 'example', e.target.value)} />
                          </div>
          ...
          <form className="p-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                <select className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 outline-none focus:border-indigo-500 text-slate-700 font-bold text-sm appearance-none cursor-pointer" value={theme} onChange={(e) => setTheme(e.target.value)}>
                  <option value="Général">Général</option>
                  <option value="Animaux">Animaux</option>
                  <option value="École">École</option>
                  <option value="Émotions">Émotions</option>
